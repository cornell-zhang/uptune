...
import uptune.opentuner
from uptune.opentuner.resultsdb.models import *

log = logging.getLogger('uptune.opentuner.utils.compactdb')
...
def main(args):
  ...
  engine, Session = uptune.opentuner.resultsdb.connect(args.database)
  session = Session()
...
if __name__ == '__main__':
  uptune.opentuner.tuningrunmain.init_logging()

...
def analyze_scores(FLAGS):
    ...
    scores_RAE = pd.DataFrame(index=scores.keys(), columns=scores[list(scores.keys())[0]].keys())
    scores_R2 = pd.DataFrame(index=scores.keys(), columns=scores[list(scores.keys())[0]].keys())
    scores_RRSE = pd.DataFrame(index=scores.keys(), columns=scores[list(scores.keys())[0]].keys())
